...
@dataclass(frozen=True)
class LayoutResult: drawer_zones: List[DrawerZone] = field(default_factory=list); door_zone: Optional[DoorZone] = None; shelf_zone: Optional[ShelfZone] = None; diagnostics: LayoutDiagnostics = field(default_factory=LayoutDiagnostics)
